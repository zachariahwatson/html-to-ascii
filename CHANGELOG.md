...
- Default useWindowDimensions width and height are determined by client, not set to zero
...
[0.9.6]: https://github.com/zachariahwatson/html-to-ascii/compare/v0.9.5...v0.9.6
